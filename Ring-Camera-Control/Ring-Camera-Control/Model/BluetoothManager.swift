...
//        var deltaX = accelerationX - accelPrev.x;
//        var deltaY = accelerationY - accelPrev.y;
//        var deltaZ = accelerationZ - accelPrev.z;
//        
//
//        // Update displacement
//        var positionXCurr = positionPrev.x + (0.5 * (deltaX + accelPrev.x)) * IMU_SAMPLE_PERIOD * IMU_SAMPLE_PERIOD
//        var positionYCurr = positionPrev.y + (0.5 * (deltaY + accelPrev.y)) * IMU_SAMPLE_PERIOD * IMU_SAMPLE_PERIOD
//        var positionZCurr = positionPrev.z + (0.5 * (deltaZ + accelPrev.z)) * IMU_SAMPLE_PERIOD * IMU_SAMPLE_PERIOD
//
//        accelPrev.x = accelerationX
//        accelPrev.y = accelerationY
//        accelPrev.z = accelerationZ
//        
//        positionPrev.x = positionXCurr
//        positionPrev.y = positionYCurr
//        positionPrev.z = positionZCurr
//        
//        //print(accelPrev.x, accelPrev.y, accelPrev.z)
//
//        // Current velocity
//        var velocityX = IMU_SAMPLE_PERIOD * (accelPrev.x + accelerationX) * 0.5 + velocityPrev.x
//        var velocityY = IMU_SAMPLE_PERIOD * (accelPrev.y + accelerationY) * 0.5 + velocityPrev.y
//        var velocityZ = IMU_SAMPLE_PERIOD * (accelPrev.z + accelerationZ) * 0.5 + velocityPrev.x
//        
//        //print(velocityX,velocityY,velocityZ)
//        
//        // Current displacement
//        var positionXCurr = IMU_SAMPLE_PERIOD * (velocityPrev.x + velocityX) * 0.5 + positionPrev.x
//        var positionYCurr = IMU_SAMPLE_PERIOD * (velocityPrev.y + velocityY) * 0.5 + positionPrev.y
//        var positionZCurr = IMU_SAMPLE_PERIOD * (velocityPrev.z + velocityZ) * 0.5 + positionPrev.z
//        
//        //print(positionXCurr,positionYCurr,positionZCurr)
//
//        
//        // Update acceleration
//        accelPrev.x = accelerationX
...
//        
//        // Update velocity
//        velocityPrev.x = velocityX
//        velocityPrev.y = velocityY
//        velocityPrev.z = velocityZ
//        
//        // Update displacement
//        positionPrev.x = positionXCurr
//        positionPrev.y = positionYCurr
...
//
//                
//        return [positionXCurr, positionYCurr, positionZCurr]
//    }
