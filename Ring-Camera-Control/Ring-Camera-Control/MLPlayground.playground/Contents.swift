...
let resizedImgTest = resizeImage(image: image!, targetSize: CGSize(width: 224, height: 224))
let norm  = resizedImgTest?.normalized()

resizedImgTest?.jpegData(compressionQuality: 1.0)
resizedImgTest?.pngData()
